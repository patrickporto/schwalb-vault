<script lang="ts">
    ...
    import DifficultyCounter from '../common/DifficultyCounter.svelte';
                    ...
                    <div class="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                             <div class="flex flex-col">
                                ...
                                <DifficultyCounter value={form.difficulty ?? 0} onUpdate={(v) => form.difficulty = v} steps={[0, 1, 5, 10, 25, 50, 100, 250, 500, 750, 1000]} />
                            </div>
                             <div>
